...
chmod 700 /opt/hiddify-manager/common/sync_live_config.sh >/dev/null 2>&1 || true
echo "* * * * * root bash /opt/hiddify-manager/common/sync_live_config.sh >> /opt/hiddify-manager/log/system/config_sync.log 2>&1" >/etc/cron.d/hiddify_config_sync
service cron reload
