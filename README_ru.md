...
Ubuntu Arm64 и AMD64 поддерживаются со следующими уровнями валидации:

| Версия Ubuntu | Статус |
| --- | --- |
| 22.04 | Поддерживается и сопровождается |
| 24.04 | Поддерживается |
| 26.04 | Экспериментальная поддержка |

`26.04` остаётся экспериментальной, пока не пройдет повторяемую end-to-end проверку в CI.
</details>
